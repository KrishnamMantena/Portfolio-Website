$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Aspiring Data Engineer", "Passionate Data Analyst", "Problem Solver", "Tech Enthusiast", "Quick Learner"],
        typeSpeed: 80,
        backSpeed: 50,
        loop: true
    });
    ...
    project1.addEventListener("click", function () {
        window.location.href = "https://github.com/KrishnamMantena/Superstore-Market-Analysis";
    });

    project2.addEventListener("click", function () {
        window.location.href = "https://github.com/KrishnamMantena/Offline-Handwritten-Expression-Evaluator";
    });
